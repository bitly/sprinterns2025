            ...
            <div className="profilesSection">
                ...
                <div className="profileContainer">
                    <div className="profileCard">
                        ...
                        <div className="profileBack">
                            <p>I'm a sophomore at CUNY Lehman College and Macaulay Honors College studying Computer Graphics and Imaging with a minor in Media Communications Studies. I hope to combine my creative and technical skills to pursue a career in product design. In my free time, I like to binge-watch shows, bake, visit new places, and spend time with family and friends.</p>
